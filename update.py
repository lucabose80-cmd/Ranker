...
for name, tooltip in factions.items():
    # Replace data-tooltip for exactly this element name
    pattern = r'(<div class="has-tooltip" data-tooltip=")[^"]*(" [^>]*>)' + name + r'</div>'
    replacement = r'\g<1>' + tooltip + r'\g<2>' + name + '</div>'
