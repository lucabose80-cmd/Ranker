...
const BOT_LEVELS = [
    { name: "Droiden (Lvl 1)", factionFocus: 'droid', fixedDeck: ["General Grievous", "B1 Battle Droide", "B2 Super Battle Droide", "Droideka", "Cal Kestis", "Kommando Droide", "Maz Kanata", "Wat Tambor", "Poggle the Lesser", "Nute Gunray"], rarities: ['common', 'rare'], popFilter: 'any', synergy: 'high', color: '#95a5a6', desc: "Nutzt viele Droiden für Verschmelzungs-Boni.", reward: 150 },
    ...
    { name: "Rebellen (Lvl 3)", factionFocus: 'rebell', fixedDeck: ["Luke Skywalker", "Ki-Adi-Mundi", "Han Solo", "Chewbacca", "Lando Calrissian", "Admiral Ackbar", "Mon Mothma", "Wedge Antilles", "Hera Syndulla", "Jyn Erso"], rarities: ['common', 'rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#e74c3c', desc: "Hofft auf Comebacks bei Rückstand.", reward: 150 },
    { name: "Erste Ordnung (Lvl 4)", factionFocus: 'erste ordnung', fixedDeck: ["Kylo Ren", "General Hux", "Captain Phasma", "Supreme Leader Snoke", "Sith Trooper", "FN-2199", "Echo", "Tup", "B1 Battle Droide", "Mother Talzin"], rarities: ['common', 'rare'], popFilter: 'any', synergy: 'high', color: '#e74c3c', desc: "Rekrutiert besiegte Karten.", reward: 150 },
    { name: "Imperium (Lvl 5)", factionFocus: 'imperium', fixedDeck: ["Darth Vader", "Emperor Palpatine", "Grand Admiral Thrawn", "Grand Moff Tarkin", "Admiral Piett", "Cassian Andor", "Jedi Interceptor (Eta-2)", "Cal Kestis", "Gregor", "Count Dooku"], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#888', desc: "Unterdrückt Gegner nach einem Sieg.", reward: 150 },
    { name: "Nachtschwestern (Lvl 6)", factionFocus: 'nachtschwester', fixedDeck: ["Mother Talzin", "Asajj Ventress", "Merrin", "Morgan Elsbeth", "Slave I", "Morgan Elsbeth", "Savage Opress", "Darth Maul", "Rancor", "Osha Aniseya"], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#9b59b6', desc: "Nutzt dunkle Magie für Nekromantie.", reward: 150 },
    { name: "Schurken (Lvl 7)", factionFocus: 'schurke', fixedDeck: ["Cad Bane", "Boba Fett", "Jango Fett", "Bossk", "Fennec Shand", "IG-88", "Hondo Ohnaka", "Qi'ra", "Dryden Vos", "Jabba the Hutt"], rarities: ['rare'], popFilter: 'any', synergy: 'high', color: '#e67e22', desc: "Klaut hinterlistig deine Score-Werte.", reward: 150 },
    { name: "Kopfgeldjäger (Lvl 8)", factionFocus: 'Kopfgeldjäger', fixedDeck: ["Boba Fett", "Jango Fett", "Cad Bane", "Bossk", "San Hill", "IG-88", "Zam Wesell", "Aurra Sing", "Embo", "Fennec Shand"], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#34495e', desc: "Macht Jagd auf deine häufigste Fraktion.", reward: 150 },
    ...
    { name: "Senat (Lvl 10)", factionFocus: 'senat', fixedDeck: ["Emperor Palpatine", "Padme Amidala", "Bail Organa", "Mon Mothma", "Dryden Vos", "Mas Amedda", "Nute Gunray", "Orn Free Taa", "Din Djarin", "Rush Clovis"], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#4da6ff', desc: "Friert Runden bei Niederlagen ein.", reward: 150 },
    { name: "Fahrzeuge (Lvl 11)", factionFocus: 'fahrzeug', fixedDeck: ["AT-AT Walker", "AT-ST", "Republic Gunship (LAAT)", "Venator-class Star Destroyer", "Imperial Star Destroyer", "TIE Interceptor", "Tech", "Third Sister", "Appo", "Millennium Falcon"], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#aaa', desc: "Gefährliche Überrollen-Taktik.", reward: 150 },
    { name: "Graue Machtnutzer (Lvl 12)", factionFocus: 'graue machtnutzer', fixedDeck: ["Ahsoka Tano", "Asajj Ventress", "Commander Bacara", "Der Vater", "Die Tochter", "Der Sohn", "Baylan Skoll", "Shin Hati", "Starkiller", "Tup"], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#ccc', desc: "Dreht die Siegesbedingung um.", reward: 150 },
    { name: "Sith (Lvl 13)", factionFocus: 'sith', fixedDeck: ["Darth Vader", "Emperor Palpatine", "Darth Maul", "Count Dooku", "Savage Opress", "Asajj Ventress", "Kylo Ren", "Supreme Leader Snoke", "Grand Inquisitor", "TIE Interceptor"], rarities: ['epic', 'legendary'], popFilter: 'any', synergy: 'high', color: '#cc4444', desc: "Zerstört passiv Karten auf deiner Hand.", reward: 150 },
    ...
    { name: "Widerstand (Lvl 15)", factionFocus: 'widerstand', fixedDeck: ["Allegiant General Pryde", "Finn", "Poe Dameron", "BB-8", "Rose Tico", "Hondo Ohnaka", "Leia Organa", "Han Solo", "Chewbacca", "Maz Kanata"], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#f39c12', desc: "Opfert Einheiten für brachiale Folge-Buffs.", reward: 150 },
    { name: "Separatisten (Lvl 16)", factionFocus: 'separatist', fixedDeck: ["Count Dooku", "General Grievous", "Nute Gunray", "Poggle the Lesser", "Wat Tambor", "B1 Battle Droide", "B2 Super Battle Droide", "Droideka", "Wrecker", "Asajj Ventress"], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#e67e22', desc: "Übermacht: Stark gegen Decks mit hohen Base-Stats.", reward: 150 },
    { name: "Monster (Lvl 17)", factionFocus: 'monster', fixedDeck: ["Rancor", "Wampa", "Sarlacc", "L3-37", "Zillo Beast", "Acklay", "Nexu", "Reek", "Rathtar", "Mudhorn"], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#8b4513', desc: "Unberechenbare Raserei-Schwankungen.", reward: 150 },
    { name: "Schmuggel (Lvl 18)", factionFocus: 'schmuggel', fixedDeck: ["Han Solo", "Chewbacca", "Lando Calrissian", "Qi'ra", "Hondo Ohnaka", "Wolffe", "Nien Nunb", "Maz Kanata", "Qui-Gon Jinn", "Rey Skywalker"], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#a0522d', desc: "Unverwüstlich: Kehren ins Deck zurück.", reward: 150 },
    { name: "212th (Lvl 19)", factionFocus: '212th', fixedDeck: ["Commander Cody", "Obi-Wan Kenobi", "Waxer", "Boil", "Commander Gree", "Han Solo", "Darth Malgus", "Admiral Ackbar", "The Armorer", "Wat Tambor"], rarities: ['common', 'rare'], popFilter: 'any', synergy: 'high', color: '#d2691e', desc: "High Ground: Kopiert gegnerische Multiplikatoren.", reward: 150 },
    ...
    { name: "Bad Batch (Lvl 21)", factionFocus: 'bad_batch', fixedDeck: ["Hunter", "Wrecker", "Tech", "Crosshair", "Echo", "Omega", "AZI-3", "Ursa Wren", "Captain Rex", "Gregor"], rarities: ['epic', 'legendary'], popFilter: 'any', synergy: 'high', color: '#696969', desc: "Kloneinheit 99: Hoher Buff, aber zufällige Folgezüge.", reward: 150 },
    { name: "Hutten (Lvl 22)", factionFocus: 'hutte', fixedDeck: ["Jabba the Hutt", "Ziro the Hutt", "Ursa Wren", "Gungi", "Gardulla the Hutt", "D-O", "AT-ST", "Commander Fox", "Rose Tico", "Qui-Gon Jinn"], rarities: ['legendary'], popFilter: 'any', synergy: 'high', color: '#2e8b57', desc: "Erpressung: Zwingt dich, deine stärkste Karte zu spielen.", reward: 150 }
];
