...
const BOT_LEVELS = [
    { name: "Droiden (Lvl 1)", factionFocus: 'droid', fixedDeck: ['R2-D2', 'C-3PO', 'General Grievous', 'BB-8', 'K-2SO', 'Chopper', 'B1 Battle Droide', 'Kommando Droide', 'IG-88', 'B2 Super Battle Droide'], rarities: ['common', 'rare'], popFilter: 'any', synergy: 'high', color: '#95a5a6', desc: "Nutzt viele Droiden für Verschmelzungs-Boni.", reward: 150 },
    { name: "Klone (Lvl 2)", factionFocus: 'klon', fixedDeck: ['Captain Rex', 'Commander Cody', 'Fives', 'Echo', 'Jesse', 'Wolffe', 'Gregor', 'Commander Bly', 'Waxer', 'Boil'], rarities: ['common', 'rare'], popFilter: 'any', synergy: 'high', color: '#f1c40f', desc: "Spielt Klone in Folge, um Ketten-Boni zu maximieren.", reward: 150 },
    { name: "Rebellen (Lvl 3)", factionFocus: 'rebell', fixedDeck: ['Han Solo', 'Leia Organa', 'Chewbacca', 'Lando Calrissian', 'Jyn Erso', 'Cassian Andor', 'Saw Gerrera', 'Mon Mothma', 'Admiral Ackbar', 'Wedge Antilles'], rarities: ['common', 'rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#e74c3c', desc: "Hofft auf Comebacks bei Rückstand.", reward: 150 },
    { name: "Erste Ordnung (Lvl 4)", factionFocus: 'erste ordnung', fixedDeck: ['Kylo Ren', 'Captain Phasma', 'General Hux', 'Supreme Leader Snoke', 'FN-2199', 'Sith Trooper', 'Allegiant General Pryde', 'Captain Peavey', 'Executioner Trooper', 'Darth Vader'], rarities: ['common', 'rare'], popFilter: 'any', synergy: 'high', color: '#e74c3c', desc: "Rekrutiert besiegte Karten.", reward: 150 },
    { name: "Imperium (Lvl 5)", factionFocus: 'imperium', fixedDeck: ['Grand Admiral Thrawn', 'Grand Inquisitor', 'Moff Gideon', 'Director Krennic', 'Admiral Piett', 'Grand Moff Tarkin', 'Imperial Royal Guard', 'Iden Versio', 'Suchdroide', 'Darth Vader'], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#888', desc: "Unterdrückt Gegner nach einem Sieg.", reward: 150 },
    { name: "Nachtschwestern (Lvl 6)", factionFocus: 'nachtschwester', fixedDeck: ['Asajj Ventress', 'Merrin', 'Morgan Elsbeth', 'Mother Talzin', 'Savage Opress', 'Count Dooku', 'General Grievous', 'Droideka', 'Wat Tambor', 'Poggle the Lesser'], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#9b59b6', desc: "Nutzt dunkle Magie für Nekromantie.", reward: 150 },
    { name: "Schurken (Lvl 7)", factionFocus: 'schurke', fixedDeck: ['Jabba the Hutt', 'Hondo Ohnaka', 'DJ', 'Enfys Nest', 'Dryden Vos', 'Qi\'ra', 'Gamorrean Guard', 'Benthic Two Tubes', 'Bib Fortuna', 'Zam Wesell'], rarities: ['rare'], popFilter: 'any', synergy: 'high', color: '#e67e22', desc: "Klaut hinterlistig deine Score-Werte.", reward: 150 },
    { name: "Kopfgeldjäger (Lvl 8)", factionFocus: 'Kopfgeldjäger', fixedDeck: ['Cad Bane', 'Embo', 'Aurra Sing', 'Bossk', 'Fennec Shand', 'Boba Fett', 'Jango Fett', 'Zam Wesell', 'IG-88', 'Din Djarin'], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#34495e', desc: "Macht Jagd auf deine häufigste Fraktion.", reward: 150 },
    { name: "Mandalorianer (Lvl 9)", factionFocus: 'mandalorian', fixedDeck: ['Din Djarin', 'Bo-Katan Kryze', 'Boba Fett', 'Cad Bane', 'Bossk', 'Jabba the Hutt', 'Hondo Ohnaka', 'Fennec Shand', 'Zam Wesell', 'Aurra Sing'], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#ff9f43', desc: "Nutzt Beskar für Silence-Effekte.", reward: 150 },
    { name: "Senat (Lvl 10)", factionFocus: 'senat', fixedDeck: ['Padme Amidala', 'Mas Amedda', 'Valorum', 'Captain Rex', 'Commander Cody', 'Fives', 'Yoda', 'Obi-Wan Kenobi', 'Mace Windu', 'Bail Organa'], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#4da6ff', desc: "Friert Runden bei Niederlagen ein.", reward: 150 },
    { name: "Fahrzeuge (Lvl 11)", factionFocus: 'fahrzeug', fixedDeck: ['AT-AT Walker', 'AT-ST', 'Imperial Star Destroyer', 'Darth Vader', 'Grand Admiral Thrawn', 'Moff Gideon', 'Director Krennic', 'Kylo Ren', 'General Hux', 'Captain Phasma'], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#aaa', desc: "Gefährliche Überrollen-Taktik.", reward: 150 },
    { name: "Graue Machtnutzer (Lvl 12)", factionFocus: 'graue machtnutzer', fixedDeck: ['Der Vater', 'Baylan Skoll', 'Shin Hati', 'Luke Skywalker', 'Ahsoka Tano', 'Ezra Bridger', 'Han Solo', 'Chewbacca', 'Leia Organa', 'Lando Calrissian'], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#ccc', desc: "Dreht die Siegesbedingung um.", reward: 150 },
    { name: "Sith (Lvl 13)", factionFocus: 'sith', fixedDeck: ['Darth Vader', 'Emperor Palpatine', 'Darth Maul', 'Count Dooku', 'Kylo Ren', 'Supreme Leader Snoke', 'Grand Inquisitor', 'Second Sister', 'Third Sister', 'Fifth Brother'], rarities: ['epic', 'legendary'], popFilter: 'any', synergy: 'high', color: '#cc4444', desc: "Zerstört passiv Karten auf deiner Hand.", reward: 150 },
    { name: "Jedi (Lvl 14)", factionFocus: 'jedi', fixedDeck: ['Yoda', 'Obi-Wan Kenobi', 'Anakin Skywalker', 'Captain Rex', 'Commander Cody', 'Fives', 'Echo', 'Jesse', 'Wolffe', 'Gregor'], rarities: ['epic', 'legendary'], popFilter: 'any', synergy: 'high', color: '#5dade2', desc: "Zwingt dich durch Gedankentricks zu Fehlern.", reward: 150 },
    { name: "Widerstand (Lvl 15)", factionFocus: 'widerstand', fixedDeck: ['Poe Dameron', 'Finn', 'Rose Tico', 'Vice Admiral Holdo', 'Maz Kanata', 'Rey Skywalker', 'Han Solo', 'Leia Organa', 'Chewbacca', 'Lando Calrissian'], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#f39c12', desc: "Opfert Einheiten für brachiale Folge-Buffs.", reward: 150 },
    { name: "Separatisten (Lvl 16)", factionFocus: 'separatist', fixedDeck: ['Zwergspinnendroide', 'Droideka', 'Wat Tambor', 'Poggle the Lesser', 'Nute Gunray', 'Admiral Trench', 'San Hill', 'Lux Bonteri', 'General Kalani', 'Count Dooku'], rarities: ['rare', 'epic'], popFilter: 'any', synergy: 'high', color: '#e67e22', desc: "Übermacht: Stark gegen Decks mit hohen Base-Stats.", reward: 150 },
    { name: "Monster (Lvl 17)", factionFocus: 'monster', fixedDeck: ['Rancor', 'Wampa', 'Sarlacc', 'Jabba the Hutt', 'Bib Fortuna', 'Gamorrean Guard', 'Boba Fett', 'Bossk', 'Gorian Shard', 'Vane'], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#8b4513', desc: "Unberechenbare Raserei-Schwankungen.", reward: 150 },
    { name: "Schmuggel (Lvl 18)", factionFocus: 'schmuggel', fixedDeck: ['Trace Martez', 'Rafa Martez', 'Han Solo', 'Chewbacca', 'Lando Calrissian', 'Hondo Ohnaka', 'Qi\'ra', 'Dryden Vos', 'Enfys Nest', 'DJ'], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#a0522d', desc: "Unverwüstlich: Kehren ins Deck zurück.", reward: 150 },
    { name: "212th (Lvl 19)", factionFocus: '212th', fixedDeck: ['Commander Cody', 'Waxer', 'Boil', 'Commander Bly', 'Commander Thorn', 'Commander Fox', 'Kix', 'Denal', 'Commander Gree', 'Obi-Wan Kenobi'], rarities: ['common', 'rare'], popFilter: 'any', synergy: 'high', color: '#d2691e', desc: "High Ground: Kopiert gegnerische Multiplikatoren.", reward: 150 },
    { name: "501st (Lvl 20)", factionFocus: '501st', fixedDeck: ['Captain Rex', 'Fives', 'Echo', 'Jesse', 'Wolffe', 'Gregor', 'Hevy', 'Flash', 'Lucky', 'Anakin Skywalker'], rarities: ['epic'], popFilter: 'any', synergy: 'high', color: '#00008b', desc: "Vaders Faust: Vernichtet zusätzliche Karten.", reward: 150 },
    { name: "Bad Batch (Lvl 21)", factionFocus: 'bad_batch', fixedDeck: ['Hunter', 'Wrecker', 'Tech', 'Crosshair', 'Omega', 'Captain Rex', 'Commander Cody', 'Fives', 'Echo', 'Jesse'], rarities: ['epic', 'legendary'], popFilter: 'any', synergy: 'high', color: '#696969', desc: "Kloneinheit 99: Hoher Buff, aber zufällige Folgezüge.", reward: 150 },
    { name: "Hutten (Lvl 22)", factionFocus: 'hutte', fixedDeck: ['Rotta the Hutt', 'Ziro the Hutt', 'Cad Bane', 'Bossk', 'Embo', 'Aurra Sing', 'Fennec Shand', 'Boba Fett', 'Jango Fett', 'Zam Wesell'], rarities: ['legendary'], popFilter: 'any', synergy: 'high', color: '#2e8b57', desc: "Erpressung: Zwingt dich, deine stärkste Karte zu spielen.", reward: 150 }
];
...
async function finishMatch() {
    ...
    if(user) {
        addDoc(collection(db, "history"), {
            ...
            mode: currentMode,
            type: "cardgame",
            gameType: isAdventureMatch ? "adventure" : "cardgame",
            adventureLevel: isAdventureMatch ? adventureLevelIndex : null,
            category: "normal",
            result: finalRes,
