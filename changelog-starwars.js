export const patchNotesStarWars = [
    {
        ...
        isHotfix: false,
        changes: [
            "UI-Update: Komplettes Redesign des Hauptmen�s! Das alte Seiten-Tab-System wurde durch ein modernes, dynamisches 'Dock'-System (unten am Bildschirmrand) und gro�e zentrierte Spielmodus-Kacheln ersetzt.",
            "Feature: Neues Benachrichtigungssystem! Wichtige Neuerungen (z.B. neue Updates, t�gliches Starwarsdle ungel�st, Shop-Aktualisierungen) werden nun mit einem gelben Punkt direkt am Button hervorgehoben.",
            "Feature: Die Home-Buttons passen sich ab sofort flie�end an dein aktuell gew�hltes Farb-Thema (z.B. Sith-Rot, Rebell-Gr�n) an.",
            "Bugfix: Der nervige gelbe Punkt am Profilfenster, der nicht mehr verschwinden wollte, wurde behoben. (Neue Karten l�sen nun keinen Profil-Dot mehr aus).",
