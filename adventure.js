...
export const ADVENTURE_CAMPAIGN = [
    ...
    { name: "Schmuggel-Ring", avatar: "", ruleId: "adv_rule_2", deck: ["Hondo Ohnaka", "Han Solo", "Chewbacca", "Bossk", "Zam Wesell", "IG-88", "Dengar", "Jabba the Hutt", "Dryden Vos", "Gorian Shard"], ruleText: "Keine Sonderregeln." },
    ...
    { name: "Piraten-Flotte", avatar: "", ruleId: "adv_rule_4", deck: ["Millennium Falcon", "Slave I", "Razor Crest", "Hondo Ohnaka", "Boba Fett", "Bossk", "Dengar", "Vane", "Gorian Shard", "Kragan Gorr"], ruleText: "Keine Sonderregeln." },
    { name: "Mandalorianische Söldner [BOSS]", avatar: "", ruleId: "adv_rule_5", deck: ["Din Djarin", "Bo-Katan Kryze", "The Armorer", "Bossk", "IG-88", "Dengar", "Aurra Sing", "Jabba the Hutt", "Cad Bane", "Zam Wesell"], ruleText: "BOSS: Gegnerische Mandalorianer verhindern deine Buffs auch bei nur 1 gespielten Mando (Silence)." },
    ...
    { name: "Fahrzeug-Depot [BOSS]", avatar: "", ruleId: "adv_rule_8", deck: ["AT-AT Walker", "AT-ST", "TIE Interceptor", "Darth Vader", "Grand Moff Tarkin", "Admiral Piett", "Stormtrooper", "Emperor Palpatine", "Count Dooku", "Asajj Ventress"], ruleText: "BOSS: Gegnerische Fahrzeuge haben +10% Basis-Stärke." },
    ...
    { name: "Schatten-Kollektiv [BOSS]", avatar: "", ruleId: "adv_rule_13", deck: ["Darth Maul", "Savage Opress", "Pre Vizsla", "Bo-Katan Kryze", "Gar Saxon", "Dryden Vos", "Qi'ra", "Mae Aniseya", "Ziro the Hutt", "Cad Bane"], ruleText: "BOSS: Deine Klone und Droiden sind durch Jamming 10% schwächer." },
    { name: "Inquisitoren", avatar: "", ruleId: "adv_rule_14", deck: ["Grand Inquisitor", "Second Sister", "Third Sister", "Darth Vader", "Grand Moff Tarkin", "Admiral Piett", "Stormtrooper", "Death Trooper", "Boba Fett", "Bossk"], ruleText: "Keine Sonderregeln." },
    ...
    { name: "Graue Wanderer", avatar: "", ruleId: "adv_rule_16", deck: ["Starkiller", "Darth Plagueis", "Darth Maul", "Asajj Ventress", "Count Dooku", "Wampa", "Rancor", "Cad Bane", "Bossk", "IG-88"], ruleText: "Keine Sonderregeln." },
    ...
    { name: "Die Erste Ordnung [BOSS]", avatar: "", ruleId: "adv_rule_18", deck: ["Kylo Ren", "Supreme Leader Snoke", "Captain Phasma", "General Hux", "Sith Trooper", "Executioner Trooper", "Allegiant General Pryde", "FN-2199", "Bo-Katan Kryze", "Vane"], ruleText: "BOSS: Besiegte Erste Ordnung-Karten kehren 1x mit 50% Stärke ins Deck des Gegners zurück!" },
    ...
    { name: "Imperator Palpatine [FINAL BOSS]", avatar: "", ruleId: "adv_rule_20", deck: ["Emperor Palpatine", "Darth Vader", "Darth Maul", "Count Dooku", "Grand Moff Tarkin", "Admiral Piett", "Imperial Royal Guard", "Stormtrooper", "Death Trooper", "Imperial Star Destroyer"], ruleText: "FINAL BOSS: Alle gegnerischen Effekte (Imperium-Unterdrückung 50%, Sith-Milling x2) sind massiv verstärkt!" }
];
