...
export const ADVENTURE_CAMPAIGN = [
    ...
    { name: "Mandalorianische Söldner [BOSS]", avatar: "", ruleId: "adv_rule_5", deck: ["Din Djarin", "Bo-Katan Kryze", "The Armorer", "Bossk", "IG-88", "Fennec Shand", "Aurra Sing", "Jabba the Hutt", "Cad Bane", "Zam Wesell"], ruleText: "BOSS: Gegnerische Mandalorianer verhindern deine Buffs auch bei nur 1 gespielten Mando (Silence)." },
    ...
    { name: "Fahrzeug-Depot [BOSS]", avatar: "", ruleId: "adv_rule_8", deck: ["AT-AT Walker", "AT-ST", "TIE Interceptor", "Darth Vader", "Grand Moff Tarkin", "Admiral Piett", "Director Krennic", "Emperor Palpatine", "Count Dooku", "Asajj Ventress"], ruleText: "BOSS: Gegnerische Fahrzeuge haben +10% Basis-Stärke." },
    ...
    { name: "Imperator Palpatine [FINAL BOSS]", avatar: "", ruleId: "adv_rule_20", deck: ["Emperor Palpatine", "Darth Vader", "Darth Maul", "Count Dooku", "Grand Moff Tarkin", "Admiral Piett", "Imperial Royal Guard", "Moff Gideon", "Director Krennic", "Imperial Star Destroyer"], ruleText: "FINAL BOSS: Alle gegnerischen Effekte (Imperium-Unterdrückung 50%, Sith-Milling x2) sind massiv verstärkt!" }
];
