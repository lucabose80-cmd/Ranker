...
export const ADVENTURE_CAMPAIGN = [
    ...
    { name: "Mandalorianische Söldner [BOSS]", avatar: "", ruleId: "adv_rule_5", deck: ["Din Djarin", "Bo-Katan Kryze", "Paz Vizsla", "The Armorer", "Koska Reeves", "Axe Woves", "Jango Fett", "Boba Fett", "Fenn Rau", "Pre Vizsla"], ruleText: "BOSS: Gegnerische Mandalorianer verhindern deine Buffs auch bei nur 1 gespielten Mando (Silence)." },
    ...
    { name: "Die 501. Legion", avatar: "", ruleId: "adv_rule_7", deck: ["Captain Rex", "Commander Cody", "Fives", "Echo", "Jesse", "Wolffe", "Gregor", "Kix", "Hardcase", "Appo"], ruleText: "Keine Sonderregeln." },
    { name: "Fahrzeug-Depot [BOSS]", avatar: "", ruleId: "adv_rule_8", deck: ["AT-AT Walker", "AT-ST", "Republic Gunship (LAAT)", "Venator-class Star Destroyer", "Imperial Star Destroyer", "TIE Interceptor", "Rush Clovis", "Second Sister", "Slave I", "Millennium Falcon"], ruleText: "BOSS: Gegnerische Fahrzeuge haben +10% Basis-Stärke." },
    ...
    { name: "Inquisitoren", avatar: "", ruleId: "adv_rule_14", deck: ["Grand Inquisitor", "Second Sister", "Third Sister", "Fifth Brother", "Seventh Sister", "Waxer", "Kylo Ren", "Darth Vader", "Trace Martez", "Suchdroide"], ruleText: "Keine Sonderregeln." },
    ...
    { name: "Graue Wanderer", avatar: "", ruleId: "adv_rule_16", deck: ["Baylan Skoll", "Shin Hati", "Starkiller", "Darth Plagueis", "Wampa", "Der Vater", "Die Tochter", "Der Sohn", "Qimir (Der Fremde)", "Asajj Ventress"], ruleText: "Keine Sonderregeln." },
    { name: "Erwachen der Macht", avatar: "", ruleId: "adv_rule_17", deck: ["Rey Skywalker", "Luke Skywalker", "Leia Organa", "San Hill", "Yoda", "Obi-Wan Kenobi", "Qui-Gon Jinn", "Mace Windu", "Plo Koon", "Ahsoka Tano"], ruleText: "Keine Sonderregeln." },
    ...
    { name: "Jedi-Rat", avatar: "", ruleId: "adv_rule_19", deck: ["Yoda", "Mace Windu", "Plo Koon", "Ki-Adi-Mundi", "Saesee Tiin", "Kit Fisto", "Shaak Ti", "Luminara Unduli", "Imperial Royal Guard", "Yaddle"], ruleText: "Keine Sonderregeln." },
