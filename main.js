...
import { initAdventureMode } from './adventure.js?v=8.3.1';
...
import { initCommunity, stopCommunity } from './community.js?v=8.3.1';
...
import { initBank, closeBank, openBank } from './bank.js';
...
function setupGameUI(user) {
    ...
    window.openSection = function(target) {
        ...
        if (target === 'bank-content') openBank();
...
window.showUnlockNotification = function(type, desc, silent = false) {
    ...
    if (type !== 'error' && !silent && window.playStarWars8BitTheme) {
