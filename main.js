...
// SAUBERER FIX: Wir schalten nur die .hidden Klasse um. Kein Konflikt mit !important mehr!
...
async function bootApp() {
    try {
        ...
        // Zeigt nun fehlerfrei nur den jeweiligen Bereich
        if (!currentUser) {
            setupAuthUI();
