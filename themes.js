...
export const THEMES = {
    starwars: [
        ...
        { id: 'sw_theme_heiss', name: 'Hot', description: 'Geheimes Theme (5 Heiße Charaktere)', cssClass: 'theme-heiss', condition: { type: 'tag_full_team', tag: 'heiss', count: 5 }, preview: '#FF1493' },
